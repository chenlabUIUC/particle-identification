function Im2 = imageEnhaceHighPass(Im, lnoise, lobject)
% NAME:     imageEnhanceHignPass.m
% PURPOSE:  This image enhancement includes background and noise
%           removement.
%           http://site.physics.georgetown.edu/matlab/tutorial.html
% INCLUDE:  imageHighPass.m
%               Attached at the end for it is only used in this function.
% INPUT:    image:  The two-dimensional array to be filtered.
...
% OUTPUT:   Im2: The two-dimensional image array after high pass filtered.
% HISTORY:  written by zihao
%           modified by zihao, 20151111. 
%               Modified imageHighPass.m as a function attached at end for 
%               it is only used in this calculation.
%               Changed the parameters for imageHighPass as input
%               parameters.
Im1 = 255 - Im; %invert the color.
Im2 = imageHighPass(Im1,lnoise,lobject);
end

function res = imageHighPass(image_array,lnoise,lobject,threshold)
% NAME:         imageHighPass.m
...
% CALLING SEQUENCE:
%               res = imageHighPass( image_array, lnoise, lobject )
% INPUTS:
